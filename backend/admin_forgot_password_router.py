"""Admin Forgot Password Router - /admin/forgot-password routes"""
...
router = APIRouter(prefix="/admin", tags=["Admin Password Recovery"])
...
async def forgot_password_submit(
    ...
    try:
        ...
        # Find user with this phone number and ADMIN role
        ...
        print("\n" + "=" * 60)
        print("📱 ADMIN FORGOT PASSWORD - OTP GENERATED (DEV MODE)")
        print("=" * 60)
        print(f"📞 Phone: {phone}")
        print(f"🔐 OTP: {otp}")
...
async def verify_otp_submit(
    ...
    try:
        ...
        print(f"✓ OTP verified for admin {phone}")
...
async def reset_password_submit(
    ...
    try:
        ...
        print(f"✓ Password reset successfully for admin {phone}")

        return templates.TemplateResponse(
            "admin/password_reset_success.html",
            {
                "request": request,
                "cart_count": 0,
                "phone": phone
